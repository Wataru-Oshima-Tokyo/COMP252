...
template <class BSTT>
typename BinaryTreeSearchHeader<BSTT>::node*  BinaryTreeSearchHeader<BSTT>::createLeaf(int key)
{
    node* n = new node;
    n->key = key;
    n->left = NULL;
...
template <class BSTT>
void BinaryTreeSearchHeader<BSTT>::addLeaf(int key)
{
    addLeafPrivate(key, root);
}

template <class BSTT>
void BinaryTreeSearchHeader<BSTT>:: addLeafPrivate(int key, node* Ptr)
{
    if (root == NULL) {
        root = createLeaf(key);
    }
...
template <class BSTT>
typename BinaryTreeSearchHeader<BSTT>::node* BinaryTreeSearchHeader<BSTT>::returnNode(int key) {
    return returnNodePrivate(key, root);
}

template <class BSTT>
typename BinaryTreeSearchHeader<BSTT>::node* BinaryTreeSearchHeader<BSTT>::returnNodePrivate(int key, node* Ptr) {
...
template <class BSTT>
int BinaryTreeSearchHeader<BSTT>::returnRootKey(){
    if (root !=NULL) {
        return root->key;
    }
    else
...
template <class BSTT>
void BinaryTreeSearchHeader<BSTT>::printChildren(int key){
...
template <class BSTT>
int BinaryTreeSearchHeader<BSTT>::findSmallest()
{
    return findSmallestPrivate(root);
}

template <class BSTT>
int BinaryTreeSearchHeader<BSTT>::findSmallestPrivate(node* Ptr)
{
    if (root == NULL) {
        cout << "The tree is empty" << endl;
        return -1;
...
template <class BSTT>
void BinaryTreeSearchHeader<BSTT>::removeNode(int key)
{
    removeNodePrivate(key, root);
}

template <class BSTT>
void BinaryTreeSearchHeader<BSTT>::removeNodePrivate(int key, node* parent)
{
    if (root != NULL) {
        if (root->key == key) {
            removeRootMatch();
